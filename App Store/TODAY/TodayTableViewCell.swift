...
class TodayTableViewCell: UITableViewCell {
    ...
    func setUPAppView(){
        ...
        appView.layer.masksToBounds = false
        appView.layer.shadowColor = UIColor(red: 204/255, green: 204/255, blue: 204/255, alpha: 1).cgColor
        appView.layer.shadowOpacity = 0.5
        appView.layer.shadowOffset = CGSize(width: -1, height: 1)
        appView.layer.shadowRadius = 1
        
        appView.layer.shadowPath = UIBezierPath(rect: self.bounds).cgPath
        appView.layer.shouldRasterize = true
        appView.layer.rasterizationScale = UIScreen.main.scale
